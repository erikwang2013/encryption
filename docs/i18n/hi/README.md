...
SM3 और SM4-CBC तब OpenSSL के नेटिव कार्यान्वयन का उपयोग करते हैं जब लिंक किया गया OpenSSL `sm3` / `sm4-cbc` प्रदान करता है (OpenSSL 1.1.1+)। अन्यथा वे `pohoc/crypto-sm` के शुद्ध-PHP कार्यान्वयन पर वापस चले जाते हैं — आउटपुट बाइट-दर-बाइट समान, परंतु बहुत धीमा: SM3 फ़ॉलबैक मेमोरी में द्विघातीय है (एक 1 MiB डाइजेस्ट के लिए ~490 MB और ~85 s, जबकि नेटिव रूप से ~4 MB पर ~60 MB/s)। CI दोनों पथों पर सूट चलाता है।
...
मास्टर-कुंजी फ़ैक्टरी: `EncryptionManagerFactory::fromMasterKey($masterKey32, 'aes-256-gcm')` हर एल्गोरिदम की उप-कुंजी व्युत्पन्न करती है और **aes-256-gcm**, **aes-256-cbc-hmac**, **sm4-cbc**, **zuc-128** तथा **sodium-xchacha20** (यदि ext-sodium उपलब्ध हो) को एक साथ रजिस्टर करती है। व्युत्पत्ति डिफ़ॉल्ट रूप से `'v1'` का उपयोग करती है; सुधरे हुए HMAC तर्क क्रम के लिए तीसरे तर्क के रूप में `'v2'` दें (दोनों एक-दूसरे को पढ़ नहीं सकते — §8 देखें)।
...
### 8. कुंजी-व्युत्पत्ति योजना v1 → v2 (वैकल्पिक माइग्रेशन)

**क्या गलत था।** प्रति-एल्गोरिदम सबकी और `aes-256-cbc-hmac`, `sm4-cbc` तथा `zuc-128` की MAC कुंजियाँ व्युत्पन्न करते समय `hash_hmac($algo, $data, $key)` को स्थिर उपयोग-लेबल HMAC **कुंजी** के रूप में और गुप्त सामग्री को **संदेश** के रूप में दिया जा रहा था — दोनों तर्क आपस में बदले हुए थे। HMAC की कुंजी गुप्त सामग्री ही होनी चाहिए।

**यह शोषणीय क्यों नहीं है।** उपयोग-लेबल एक सार्वजनिक स्थिरांक है और गुप्त सामग्री अब भी HMAC में जाती है; मास्टर कुंजी (या सिफ़र कुंजी) के बिना हमलावर न कुछ व्युत्पन्न कर सकता है, न कुछ जाली बना सकता है। केवल तर्कों का क्रम गलत था, व्युत्पत्ति की मज़बूती नहीं।

**कैसे स्विच करें।** तीसरे तर्क के रूप में `'v2'` दें। इसे छोड़ देने पर आज का व्यवहार बाइट-दर-बाइट वैसा ही रहता है, इसलिए मौजूदा हर कॉल साइट अपरिवर्तित रहती है:
...
MAC-आधारित हर एन्क्रिप्टर वही स्विच अंतिम वैकल्पिक तर्क के रूप में लेता है — `new Sm4CbcEncryptor($key16, macDerivation: 'v2')`। अज्ञात स्कीम नाम चुपचाप v1 पर लौटने के बजाय `EncryptionException` फेंकता है।

**माइग्रेशन।** v1 और v2 *अलग* सबकी और MAC कुंजियाँ व्युत्पन्न करते हैं, इसलिए वे परस्पर विनिमेय नहीं हैं: v2 मैनेजर v1 सिफ़रटेक्स्ट को डिक्रिप्ट नहीं कर सकता और v1 मैनेजर v2 सिफ़रटेक्स्ट को नहीं (MAC / प्रमाणीकरण विफलता)। स्कीम का कोई ऑन-वायर मार्कर नहीं है — दोनों एक ही `v1` पेलोड प्रीफ़िक्स लिखते हैं — इसलिए माइग्रेशन के दौरान गलत स्कीम से पढ़ना छेड़छाड़ किए गए सिफ़रटेक्स्ट से अलग नहीं पहचाना जा सकता: दोनों MAC विफलता के रूप में सामने आते हैं। माइग्रेशन के दौरान हर पढ़ने पर इस्तेमाल हुई स्कीम लॉग करें, और ऐसी विफलताओं पर भ्रष्टाचार मानने से पहले स्कीम की असंगति की आशा रखें। दोनों मैनेजर एक ही मास्टर कुंजी से बनाएँ और पहले पढ़ें, फिर लिखें:
...
संग्रहीत डेटा (सत्र और टोकन सहित) दोबारा एन्क्रिप्ट करें और v1 सिफ़रटेक्स्ट शेष न रहने पर v1 मैनेजर को हटा दें। मास्टर कुंजी स्वयं नहीं बदलती: व्युत्पत्ति योजना बदलना कुंजी रोटेशन नहीं है।

**पेलोड प्रीफ़िक्स से असंबंधित।** `v1 | IV | MAC | ciphertext` पेलोड संरचना का `v1` *सिफ़रटेक्स्ट फ़ॉर्मैट* संस्करण है, यह व्युत्पत्ति योजना नहीं — v2 में भी प्रीफ़िक्स `v1` ही रहता है, और पुराने ब्लॉब अपना प्रीफ़िक्स बनाए रखते हैं। इसे नाम न दें।
...
├── .github/workflows/tests.yml      CI में PHP 8.0–8.4 पर phpunit (gmp + sodium)
├── composer.json                    psr-4 ऑटोलोड, PHP ^8.0, phpunit डेव निर्भरता
├── phpunit.xml.dist
├── SECURITY.md                      भेद्यता प्रकटीकरण नीति
...
5. **कोई भेद्यता मिली?** इसकी सूचना निजी रूप से दें — देखें [`SECURITY.md`](../../../SECURITY.md)।
